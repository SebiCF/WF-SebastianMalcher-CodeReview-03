...
function createNextPageButton(movies) {
...
function sortMoviesByLikesDesc(movieCounter) {
    ...
    let currentActivePageButton = document.querySelector("[class=nextMoviePageBtn]" + currentActivePageNumber)
...
function sortMoviesByLikesAsc(movieCounter) {
    ...
    let currentActivePageNumber = movieCounter / 10 - 1;
    let currentActivePageButton = document.getElementById("nextMoviePageBtn" + currentActivePageNumber);
    currentActivePageButton.style.color = "#5591ff";
    currentActivePageButton.style.textDecorationColor = "#5591ff";
